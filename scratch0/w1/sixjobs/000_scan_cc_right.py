...
#####################
# This script changes the voltage of the CCs ONLY RIGHT of IP1
...
study_prefix          = 'DA_Ioct300_C1e-3_Q15_CCs-190_'
...
knobs_right_all = np.arange(0., 201., 10.)#np.concatenate([np.arange(0., 91., 10.), [99.999], np.arange(110., 201., 10.)])
